...
int main() {
    ...
    for(int k=0; k < nyquistLimit*1; k++) {
        complex<double> xk;
        SineOscillator sineOscillator(cFreqint, eFreqint, gFreqint, bFreqint, amp);
        // cout<<xk<<'\n';
        //SineOscillator sineOscillator(a4, amp);
        // cout<<"angle: "<<sineOscillator.getAngle()<<endl;
        for(int n=0; n < N; n++) {
            ...
            complex<double> complexSample(sampleC);
            ...
            xk += complexSample * (leftEulers - i*rightEulers) * hanWindowComplex;
            //cout<<leftEulers<<" "<<rightEulers<<endl;
            //cout<<bn_val<<endl;
            //cout<<leftEulers + i*rightEulers<<endl;
            //cout<<sampleC<<" "<<complexSample<<endl;
        }
